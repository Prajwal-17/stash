...
function SheetContent({
  ...
  return (
    <SheetPortal>
      <DialogPrimitive.Overlay className="data-[state=open]:animate-in data-[state=closed]:animate-out fixed inset-0 z-50 bg-black/50 backdrop-blur-sm" />
      <DialogPrimitive.Content {...props} className={cn(sheetVariants({ side }), className)}>
        {children}
