  ...
  ({ className, ...props }, ref) => {
    return (
      <textarea
        data-slot="textarea"
        className={cn(
          "border-input bg-card text-foreground flex min-h-24 w-full min-w-0 rounded-md border px-3 py-2 text-base leading-relaxed transition-[border-color,box-shadow] sm:text-sm",
